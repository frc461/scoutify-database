  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved match as @match" do
        ...
        post :create, {:match => { "event_id" => "invalid value" }}, valid_session
        assigns(:match).should be_a_new(Match)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested match" do
        ...
        Match.any_instance.should_receive(:update).with({ "event_id" => "1" })
        put :update, {:id => match.to_param, :match => { "event_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the match as @match" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Match.any_instance.stub(:save).and_return(false)
        put :update, {:id => match.to_param, :match => { "event_id" => "invalid value" }}, valid_session
        assigns(:match).should eq(match)
      end
